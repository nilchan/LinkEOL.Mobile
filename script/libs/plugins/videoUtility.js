document.addEventListener("plusready", function() {
	...
	var VideoUtility = {
		 ...
		 * @param  w 视频的高
		 * @param  h 视频的宽
		 * @param {Number} bitRate 码率  500*1024
		 * @return {String} json格式字符串
		 * @param {Object} 
		 */
		recordVideo: function(w, h, bitRate, successCallback, errorCallback) {
			...
			return _BRIDGE.exec(_VIDEOPLUGIN, "recordVideo", [callbackID, w, h, bitRate]);
		},
